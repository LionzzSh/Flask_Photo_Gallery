...
*(Примітка: Завантажте всі файли зі скріншотів із папки `Demo/` до кореневої директорії репозиторію або створіть папку `screenshots/` і перенесіть туди, оновивши шляхи в таблиці, наприклад, `screenshots/сторінка входу.jpg`.)*
